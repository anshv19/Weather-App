...
const WeatherCard = ({
  ...
  return (
    <div className='w-[22rem] min-w-[22rem] h-[30rem] glassCard p-4'>
      <div className='flex w-20 just-center items-center gap-5 mt-12 mb-4 h-5rem'>
        <img src={icon} alt="weather_icon" class='h-5rem' />
        <p className='font-bold text-5xl' >{temperature}</p><p className='text-5xl'>&deg;C</p>
      </div>
